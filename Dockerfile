...
RUN			dpkg --add-architecture i386 && \
			apt update && \
			apt upgrade -y && \
			apt install -y lib32gcc-s1 lib32stdc++6 unzip curl iproute2 tzdata libgdiplus libsdl2-2.0-0:i386 jq moreutils libstdc++6 build-essential software-properties-common
